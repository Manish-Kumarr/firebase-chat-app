...
const Chats = () => {
  ...
  const handleSelect = (user, selectedChatId) => {
    ...
    if (unreadMsgs?.[selectedChatId]?.length > 0) readChat(selectedChatId);
  };
    ...
    <div className='flex flex-col h-full'>
      <div className='shrink-0 sticky -top-[20px] z-10 flex justify-center w-full bg-c2 py-5'>
        ...
        <input
          ...
          className='w-[300px] h-12 rounded-xl outline-none placeholder:text-c3 text-base bg-c1/[0.5] pl-11 pr-5'
        />
      </div>
